...
func (ctx *Wechat) GetComponentAccessToken() (string, error) {
...
func (ctx *Wechat) SetComponentAccessToken(verifyTicket string) (*ComponentAccessToken, error) {
...
// GetPreCode 获取预授权码
func (ctx *Wechat) GetPreCode() (string, error) {
...
func (ctx *Wechat) QueryAuthCode(authCode string) (*AuthBaseInfo, error) {
	cat, err := ctx.GetComponentAccessToken()
	if err != nil {
		return nil, err
	}
...
func (ctx *Wechat) RefreshAuthrToken(appid, refreshToken string) (*AuthrAccessToken, error) {
	cat, err := ctx.GetComponentAccessToken()
	if err != nil {
		return nil, err
	}
...
func (ctx *Wechat) GetAuthrAccessToken(appid string) (string, error) {
	authrTokenKey := "authorizer_access_token_" + appid
...
func (ctx *Wechat) GetAuthrInfo(appid string) (*AuthorizerInfo, *AuthBaseInfo, error) {
	cat, err := ctx.GetComponentAccessToken()
	if err != nil {
		return nil, nil, err
	}
