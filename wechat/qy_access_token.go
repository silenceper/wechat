...
func (ctx *Wechat) SetQyAccessTokenLock(l *sync.RWMutex) {
	ctx.accessTokenLock = l
}

//GetQyAccessToken 获取access_token
func (ctx *Wechat) GetQyAccessToken() (accessToken string, err error) {
...
func (ctx *Wechat) GetQyAccessTokenFromServer() (resQyAccessToken ResQyAccessToken, err error) {
